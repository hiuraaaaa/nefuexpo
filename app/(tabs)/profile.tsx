...
function AnnouncementModal({ visible, onClose, theme }: { visible: boolean; onClose: () => void; theme: any }) {
  const TYPES = [
...
export default function ProfileScreen() {
  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: theme.bg }} edges={['top']}>
      ...
      <MaintenanceModal visible={showMaintenance} onClose={() => setShowMaintenance(false)} theme={theme} />
      <AnnouncementModal visible={showAnnouncement} onClose={() => setShowAnnouncement(false)} theme={theme} />
                ...
                >
                  ...
                  <View style={{ flex: 1 }}>
                    <View style={{ flexDirection: 'row', alignItems: 'center', gap: 6 }}>
                      ...
                      {item.isAdmin && <View style={{ backgroundColor: theme.accent, paddingHorizontal: 5, paddingVertical: 2, borderRadius: 4 }}><Text style={{ color: theme.bg, fontSize: 8, fontWeight: '900' }}>ADMIN</Text></View>}
                    </View>
