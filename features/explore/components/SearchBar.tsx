...
//
// Search bar biasa — kotak input dengan ikon kaca pembesar, dipasang
// permanen di atas layar Explore (bukan lagi headline-text yang jadi
// input). Style konsisten sama SearchModal biar gak ambigu di seluruh app.
